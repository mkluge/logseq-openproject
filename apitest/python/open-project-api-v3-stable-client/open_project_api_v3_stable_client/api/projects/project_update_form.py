...
from ...models.project_update_form_json_body import ProjectUpdateFormJsonBody
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: ProjectUpdateFormJsonBody,
) -> Dict[str, Any]:
    url = "{}/api/v3/projects/{id}/form".format(client.base_url, id=id)
