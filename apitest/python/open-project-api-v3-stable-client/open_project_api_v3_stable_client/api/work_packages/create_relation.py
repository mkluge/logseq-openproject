...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/api/v3/work_packages/{id}/relations".format(client.base_url, id=id)
...
def sync_detailed(
    ...
    *,
    ...
    The required fields of a Relation can be found in its schema, which is embedded in the respective
    form.
