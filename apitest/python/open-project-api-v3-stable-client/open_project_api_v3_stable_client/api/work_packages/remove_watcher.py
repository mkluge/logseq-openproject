...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/api/v3/work_packages/{id}/watchers/{user_id}".format(client.base_url, id=id, user_id=user_id)
...
def sync_detailed(
    ...
    *Note: This might also be the case, if the specified user did not watch the work package prior to
    the request.*
