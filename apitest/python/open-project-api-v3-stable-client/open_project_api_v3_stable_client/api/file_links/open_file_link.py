...
def _get_kwargs(
    ...
    *,
    client: Client,
    location: Union[Unset, None, bool] = UNSET,
) -> Dict[str, Any]:
    url = "{}/api/v3/file_links/{id}/open".format(client.base_url, id=id)
...
def sync_detailed(
    ...
    *,
    ...
    """Creates an opening uri of the linked file.
     ...
     Creates a uri to open the origin file linked by the given file link. This uri depends on the storage
    type and
    is always located on the origin storage itself.

    Args:
        id (int):
        location (Union[Unset, None, bool]):
