...
T = TypeVar("T", bound="RootModelLinksMemberships")
...
class RootModelLinksMemberships:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        root_model_links_memberships = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        root_model_links_memberships.additional_properties = d
        return root_model_links_memberships
