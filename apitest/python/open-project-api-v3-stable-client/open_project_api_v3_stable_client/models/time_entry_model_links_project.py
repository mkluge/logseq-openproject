...
T = TypeVar("T", bound="TimeEntryModelLinksProject")
...
class TimeEntryModelLinksProject:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        time_entry_model_links_project = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        time_entry_model_links_project.additional_properties = d
        return time_entry_model_links_project
