...
T = TypeVar("T", bound="NotificationModelLinksReadIAN")
...
class NotificationModelLinksReadIAN:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        notification_model_links_read_ian = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        notification_model_links_read_ian.additional_properties = d
        return notification_model_links_read_ian
