...
T = TypeVar("T", bound="RevisionModelLinksShowRevision")
...
class RevisionModelLinksShowRevision:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        revision_model_links_show_revision = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        revision_model_links_show_revision.additional_properties = d
        return revision_model_links_show_revision
