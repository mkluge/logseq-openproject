...
T = TypeVar("T", bound="DocumentModelLinksAttachments")
...
class DocumentModelLinksAttachments:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        document_model_links_attachments = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        document_model_links_attachments.additional_properties = d
        return document_model_links_attachments
