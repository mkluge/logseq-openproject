...
T = TypeVar("T", bound="NotificationModelLinksSelf")
...
class NotificationModelLinksSelf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        notification_model_links_self = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        notification_model_links_self.additional_properties = d
        return notification_model_links_self
