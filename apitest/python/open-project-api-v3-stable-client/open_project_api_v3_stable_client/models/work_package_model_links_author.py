...
T = TypeVar("T", bound="WorkPackageModelLinksAuthor")
...
class WorkPackageModelLinksAuthor:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        work_package_model_links_author = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        work_package_model_links_author.additional_properties = d
        return work_package_model_links_author
