...
T = TypeVar("T", bound="WorkPackageModelLinksSelf")
...
class WorkPackageModelLinksSelf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        work_package_model_links_self = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        work_package_model_links_self.additional_properties = d
        return work_package_model_links_self
