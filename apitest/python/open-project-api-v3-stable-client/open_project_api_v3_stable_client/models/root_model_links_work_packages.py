...
T = TypeVar("T", bound="RootModelLinksWorkPackages")
...
class RootModelLinksWorkPackages:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        root_model_links_work_packages = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        root_model_links_work_packages.additional_properties = d
        return root_model_links_work_packages
