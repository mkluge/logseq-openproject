...
T = TypeVar("T", bound="WorkPackageModelLinksWatchers")
...
class WorkPackageModelLinksWatchers:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        work_package_model_links_watchers = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        work_package_model_links_watchers.additional_properties = d
        return work_package_model_links_watchers
