...
T = TypeVar("T", bound="FileLinkReadModelLinksStorage")
...
class FileLinkReadModelLinksStorage:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        file_link_read_model_links_storage = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        file_link_read_model_links_storage.additional_properties = d
        return file_link_read_model_links_storage
