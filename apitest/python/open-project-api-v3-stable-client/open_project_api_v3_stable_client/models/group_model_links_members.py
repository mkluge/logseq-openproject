...
T = TypeVar("T", bound="GroupModelLinksMembers")


@attr.s(auto_attribs=True)
class GroupModelLinksMembers:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        group_model_links_members.additional_properties = d
        return group_model_links_members
