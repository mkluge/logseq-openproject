...
T = TypeVar("T", bound="RootModelLinksConfiguration")
...
class RootModelLinksConfiguration:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        root_model_links_configuration = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        root_model_links_configuration.additional_properties = d
        return root_model_links_configuration
