...
T = TypeVar("T", bound="FileCollectionModelLinksSelf")


@attr.s(auto_attribs=True)
class FileCollectionModelLinksSelf:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        file_collection_model_links_self = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        file_collection_model_links_self.additional_properties = d
        return file_collection_model_links_self
