...
T = TypeVar("T", bound="RevisionModelLinksProject")
...
class RevisionModelLinksProject:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        revision_model_links_project = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        revision_model_links_project.additional_properties = d
        return revision_model_links_project
