...
T = TypeVar("T", bound="QueryFilterInstanceSchemaModelLinksSelf")
...
class QueryFilterInstanceSchemaModelLinksSelf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        query_filter_instance_schema_model_links_self = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        query_filter_instance_schema_model_links_self.additional_properties = d
        return query_filter_instance_schema_model_links_self
