...
T = TypeVar("T", bound="AvailableAssigneesModel")
...
class AvailableAssigneesModel:
    """
    Example:
        {'_links': {'self': {'href': '/api/v3/projects/42/available_assignees'}}, 'total': 2, 'count': 2, '_type':
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        available_assignees_model = cls()

        available_assignees_model.additional_properties = d
        return available_assignees_model
