...
T = TypeVar("T", bound="WeekDaySelfLinkModelSelf")
...
class WeekDaySelfLinkModelSelf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        week_day_self_link_model_self = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        week_day_self_link_model_self.additional_properties = d
        return week_day_self_link_model_self
