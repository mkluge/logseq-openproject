...
T = TypeVar("T", bound="StorageModelLinksAuthorize")


@attr.s(auto_attribs=True)
class StorageModelLinksAuthorize:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        storage_model_links_authorize = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        storage_model_links_authorize.additional_properties = d
        return storage_model_links_authorize
