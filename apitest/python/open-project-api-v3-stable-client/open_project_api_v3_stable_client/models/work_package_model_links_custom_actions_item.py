...
T = TypeVar("T", bound="WorkPackageModelLinksCustomActionsItem")


@attr.s(auto_attribs=True)
class WorkPackageModelLinksCustomActionsItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        work_package_model_links_custom_actions_item = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        work_package_model_links_custom_actions_item.additional_properties = d
        return work_package_model_links_custom_actions_item
