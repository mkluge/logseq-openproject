...
T = TypeVar("T", bound="GroupModelLinksMemberships")
...
class GroupModelLinksMemberships:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        group_model_links_memberships = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        group_model_links_memberships.additional_properties = d
        return group_model_links_memberships
