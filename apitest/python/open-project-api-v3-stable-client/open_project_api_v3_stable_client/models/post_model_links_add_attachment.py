...
T = TypeVar("T", bound="PostModelLinksAddAttachment")
...
class PostModelLinksAddAttachment:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        post_model_links_add_attachment = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        post_model_links_add_attachment.additional_properties = d
        return post_model_links_add_attachment
