...
T = TypeVar("T", bound="GroupModelLinksUpdateImmediately")
...
class GroupModelLinksUpdateImmediately:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        group_model_links_update_immediately = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        group_model_links_update_immediately.additional_properties = d
        return group_model_links_update_immediately
