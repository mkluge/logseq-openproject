...
T = TypeVar("T", bound="FormModelLinksSelf")


@attr.s(auto_attribs=True)
class FormModelLinksSelf:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        form_model_links_self.additional_properties = d
        return form_model_links_self
