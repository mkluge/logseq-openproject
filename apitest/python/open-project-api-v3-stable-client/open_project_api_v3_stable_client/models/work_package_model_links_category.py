...
T = TypeVar("T", bound="WorkPackageModelLinksCategory")
...
class WorkPackageModelLinksCategory:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        work_package_model_links_category = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        work_package_model_links_category.additional_properties = d
        return work_package_model_links_category
