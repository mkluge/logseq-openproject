...
T = TypeVar("T", bound="TimeEntryModelLinksActivity")
...
class TimeEntryModelLinksActivity:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        time_entry_model_links_activity = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        time_entry_model_links_activity.additional_properties = d
        return time_entry_model_links_activity
