...
T = TypeVar("T", bound="FileLinkReadModelLinksDelete")
...
class FileLinkReadModelLinksDelete:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        file_link_read_model_links_delete = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        file_link_read_model_links_delete.additional_properties = d
        return file_link_read_model_links_delete
