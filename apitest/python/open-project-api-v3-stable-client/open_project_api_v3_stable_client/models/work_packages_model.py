...
if TYPE_CHECKING:
    ...
    from ..models.work_packages_model_embedded import WorkPackagesModelEmbedded
    from ..models.work_packages_model_links import WorkPackagesModelLinks


T = TypeVar("T", bound="WorkPackagesModel")
...
class WorkPackagesModel:
    """
    Example:
        {'_links': {'self': {'href': '/api/v3/work_packages'}}, 'total': 2, 'count': 2, '_type': 'Collection',
            '_embedded': {'elements': [{'_hint': 'Work package resource shortened for brevity', '_type': 'WorkPackage',
            '_links': {'self': {'href': '/api/v3/work_packages/1'}}, 'id': 1}, {'_hint': 'Work package resource shortened
            for brevity', '_type': 'WorkPackage', '_links': {'self': {'href': '/api/v3/work_packages/2'}}, 'id': 2}]}}

    Attributes:
        field_links (WorkPackagesModelLinks):
        field_embedded (WorkPackagesModelEmbedded):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        field_links = WorkPackagesModelLinks.from_dict(d.pop("_links"))

        field_embedded = WorkPackagesModelEmbedded.from_dict(d.pop("_embedded"))
        ...
        work_packages_model.additional_properties = d
        return work_packages_model
