...
T = TypeVar("T", bound="RelationModelLinksSelf")
...
class RelationModelLinksSelf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        relation_model_links_self.additional_properties = d
        return relation_model_links_self
