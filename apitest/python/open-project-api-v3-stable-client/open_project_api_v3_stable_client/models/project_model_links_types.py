...
T = TypeVar("T", bound="ProjectModelLinksTypes")
...
class ProjectModelLinksTypes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_model_links_types.additional_properties = d
        return project_model_links_types
