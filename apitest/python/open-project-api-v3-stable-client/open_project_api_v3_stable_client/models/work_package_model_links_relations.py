...
T = TypeVar("T", bound="WorkPackageModelLinksRelations")
...
class WorkPackageModelLinksRelations:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        work_package_model_links_relations = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        work_package_model_links_relations.additional_properties = d
        return work_package_model_links_relations
