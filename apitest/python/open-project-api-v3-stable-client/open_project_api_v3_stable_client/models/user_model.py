...
class UserModel:
    """
    Example:
        {'_type': 'User', 'id': 1, 'name': 'John Sheppard', 'login': 'j.sheppard', 'firstName': 'John', 'lastName':
            'Sheppard', 'email': 'shep@mail.com', 'admin': True, 'avatar': 'https://example.org/users/1/avatar', 'status':
            'active', 'identityUrl': 'null,', 'language': 'en', 'createdAt': '2014-05-21T08:51:20Z', 'updatedAt':
            '2014-05-21T08:51:20Z', '_links': {'self': {'href': '/api/v3/users/1', 'title': 'John Sheppard'}, 'memberships':
            {'href': '/api/v3/memberships?filters=%5B%7B%22principal%22%3A%7B%22operator%22%3A%22%3D%22%2C%22values%22%3A%5B
            %221%22%5D%7D%7D%5D,', 'title': 'Members'}, 'showUser': {'href': '/users/1', 'type': 'text/html'}, 'lock':
            {'href': '/api/v3/users/1/lock', 'title': 'Set lock on John Sheppard', 'method': 'post'}, 'updateImmediately':
            {'href': '/api/v3/users/1', 'title': 'update John Sheppard', 'method': 'patch'}, 'delete': {'href':
            '/api/v3/users/1', 'title': 'delete John Sheppard'}, 'method': 'delete'}}
