...
T = TypeVar("T", bound="WorkPackageModelLinksParent")
...
class WorkPackageModelLinksParent:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        work_package_model_links_parent = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        work_package_model_links_parent.additional_properties = d
        return work_package_model_links_parent
