...
T = TypeVar("T", bound="ProjectModelLinksCreateWorkPackage")
...
class ProjectModelLinksCreateWorkPackage:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_model_links_create_work_package = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        project_model_links_create_work_package.additional_properties = d
        return project_model_links_create_work_package
