...
T = TypeVar("T", bound="ProjectModelLinksDelete")
...
class ProjectModelLinksDelete:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_model_links_delete = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        project_model_links_delete.additional_properties = d
        return project_model_links_delete
