...
if TYPE_CHECKING:
    ...
    from ..models.file_link_collection_write_model_embedded import FileLinkCollectionWriteModelEmbedded


T = TypeVar("T", bound="FileLinkCollectionWriteModel")
...
class FileLinkCollectionWriteModel:
    """
    Example:
        {'_embedded': {'elements': [{'originData': {'id': 5503, 'name': 'logo.png', 'mimeType': 'image/png', 'size':
            16042, 'createdAt': '2021-12-19T09:42:10.170Z', 'lastModifiedAt': '2021-12-20T14:00:13.987Z', 'createdByName':
            'Luke Skywalker', 'lastModifiedByName': 'Anakin Skywalker'}, '_links': {'storage': {'href':
            '/api/v3/storage/42'}}}, {'_hint': 'File Link resource shortened for brevity', 'id': 1338}]}}

    Attributes:
        field_embedded (FileLinkCollectionWriteModelEmbedded):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        field_embedded = FileLinkCollectionWriteModelEmbedded.from_dict(d.pop("_embedded"))
        ...
        file_link_collection_write_model = cls(
        ...
        file_link_collection_write_model.additional_properties = d
        return file_link_collection_write_model
