...
T = TypeVar("T", bound="AttachmentModelDescription")
...
class AttachmentModelDescription:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        attachment_model_description = cls(
            format_=format_,
            raw=raw,
            html=html,
        )

        attachment_model_description.additional_properties = d
        return attachment_model_description
