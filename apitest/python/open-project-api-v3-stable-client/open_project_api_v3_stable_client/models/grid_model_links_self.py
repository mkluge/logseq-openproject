...
T = TypeVar("T", bound="GridModelLinksSelf")


@attr.s(auto_attribs=True)
class GridModelLinksSelf:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        grid_model_links_self.additional_properties = d
        return grid_model_links_self
