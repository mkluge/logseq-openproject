...
T = TypeVar("T", bound="StorageModelLinksAuthorizationState")


@attr.s(auto_attribs=True)
class StorageModelLinksAuthorizationState:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        storage_model_links_authorization_state = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        storage_model_links_authorization_state.additional_properties = d
        return storage_model_links_authorization_state
