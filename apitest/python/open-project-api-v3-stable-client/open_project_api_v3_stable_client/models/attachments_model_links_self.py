...
T = TypeVar("T", bound="AttachmentsModelLinksSelf")


@attr.s(auto_attribs=True)
class AttachmentsModelLinksSelf:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        attachments_model_links_self = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        attachments_model_links_self.additional_properties = d
        return attachments_model_links_self
