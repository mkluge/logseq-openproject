...
T = TypeVar("T", bound="MembershipModelLinksProject")


@attr.s(auto_attribs=True)
class MembershipModelLinksProject:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        membership_model_links_project = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        membership_model_links_project.additional_properties = d
        return membership_model_links_project
