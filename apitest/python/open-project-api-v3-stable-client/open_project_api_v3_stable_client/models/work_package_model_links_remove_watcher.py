...
T = TypeVar("T", bound="WorkPackageModelLinksRemoveWatcher")
...
class WorkPackageModelLinksRemoveWatcher:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        work_package_model_links_remove_watcher = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        work_package_model_links_remove_watcher.additional_properties = d
        return work_package_model_links_remove_watcher
