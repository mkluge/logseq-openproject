...
T = TypeVar("T", bound="RootModelLinksPriorities")
...
class RootModelLinksPriorities:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        root_model_links_priorities = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        root_model_links_priorities.additional_properties = d
        return root_model_links_priorities
