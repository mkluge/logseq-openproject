...
T = TypeVar("T", bound="HelptextModelLinksEditText")
...
class HelptextModelLinksEditText:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        helptext_model_links_edit_text = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        helptext_model_links_edit_text.additional_properties = d
        return helptext_model_links_edit_text
