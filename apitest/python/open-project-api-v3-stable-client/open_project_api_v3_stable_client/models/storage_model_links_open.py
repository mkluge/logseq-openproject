...
T = TypeVar("T", bound="StorageModelLinksOpen")


@attr.s(auto_attribs=True)
class StorageModelLinksOpen:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        storage_model_links_open.additional_properties = d
        return storage_model_links_open
