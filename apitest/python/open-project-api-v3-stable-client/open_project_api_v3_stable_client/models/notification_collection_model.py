...
if TYPE_CHECKING:
    ...
    from ..models.notification_collection_model_embedded import NotificationCollectionModelEmbedded
    from ..models.notification_collection_model_links import NotificationCollectionModelLinks


T = TypeVar("T", bound="NotificationCollectionModel")
...
class NotificationCollectionModel:
    """
    Attributes:
        field_links (NotificationCollectionModelLinks):
        field_embedded (NotificationCollectionModelEmbedded):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        field_links = NotificationCollectionModelLinks.from_dict(d.pop("_links"))

        field_embedded = NotificationCollectionModelEmbedded.from_dict(d.pop("_embedded"))
        ...
        notification_collection_model = cls(
        ...
        notification_collection_model.additional_properties = d
        return notification_collection_model
