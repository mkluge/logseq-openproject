...
T = TypeVar("T", bound="WorkPackageModelLinksFileLinks")
...
class WorkPackageModelLinksFileLinks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        work_package_model_links_file_links = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        work_package_model_links_file_links.additional_properties = d
        return work_package_model_links_file_links
