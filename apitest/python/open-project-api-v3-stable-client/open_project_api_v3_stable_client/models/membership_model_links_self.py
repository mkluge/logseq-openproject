...
T = TypeVar("T", bound="MembershipModelLinksSelf")


@attr.s(auto_attribs=True)
class MembershipModelLinksSelf:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        membership_model_links_self = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        membership_model_links_self.additional_properties = d
        return membership_model_links_self
