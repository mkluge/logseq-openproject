...
T = TypeVar("T", bound="RootModelLinksRelations")
...
class RootModelLinksRelations:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        root_model_links_relations = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        root_model_links_relations.additional_properties = d
        return root_model_links_relations
