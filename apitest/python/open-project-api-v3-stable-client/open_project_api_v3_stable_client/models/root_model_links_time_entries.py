...
T = TypeVar("T", bound="RootModelLinksTimeEntries")
...
class RootModelLinksTimeEntries:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        root_model_links_time_entries = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        root_model_links_time_entries.additional_properties = d
        return root_model_links_time_entries
