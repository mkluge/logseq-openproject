...
T = TypeVar("T", bound="UserModelLinksUpdateImmediately")
...
class UserModelLinksUpdateImmediately:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        user_model_links_update_immediately = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        user_model_links_update_immediately.additional_properties = d
        return user_model_links_update_immediately
