...
T = TypeVar("T", bound="WorkPackageModelLinksAddAttachment")
...
class WorkPackageModelLinksAddAttachment:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        work_package_model_links_add_attachment = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        work_package_model_links_add_attachment.additional_properties = d
        return work_package_model_links_add_attachment
