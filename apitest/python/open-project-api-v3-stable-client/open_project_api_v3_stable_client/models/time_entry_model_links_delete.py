...
T = TypeVar("T", bound="TimeEntryModelLinksDelete")
...
class TimeEntryModelLinksDelete:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        time_entry_model_links_delete = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        time_entry_model_links_delete.additional_properties = d
        return time_entry_model_links_delete
