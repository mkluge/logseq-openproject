...
T = TypeVar("T", bound="WikiPageModelLinksAddAttachment")
...
class WikiPageModelLinksAddAttachment:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        wiki_page_model_links_add_attachment = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        wiki_page_model_links_add_attachment.additional_properties = d
        return wiki_page_model_links_add_attachment
