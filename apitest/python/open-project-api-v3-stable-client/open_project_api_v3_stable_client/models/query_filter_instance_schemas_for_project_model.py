...
T = TypeVar("T", bound="QueryFilterInstanceSchemasForProjectModel")


@attr.s(auto_attribs=True)
class QueryFilterInstanceSchemasForProjectModel:
    """
    Example:
        {'_type': 'Collection', 'total': 2, 'count': 2, '_embedded': {'elements': [{'_type':
            ...
            'Author'}}}]}, '_links': {'self': {'href': '/api/v3/projects/42/queries/filter_instance_schemas'}}}
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        query_filter_instance_schemas_for_project_model = cls()

        query_filter_instance_schemas_for_project_model.additional_properties = d
        return query_filter_instance_schemas_for_project_model
