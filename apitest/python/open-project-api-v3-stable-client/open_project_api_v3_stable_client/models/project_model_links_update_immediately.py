...
T = TypeVar("T", bound="ProjectModelLinksUpdateImmediately")
...
class ProjectModelLinksUpdateImmediately:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_model_links_update_immediately = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        project_model_links_update_immediately.additional_properties = d
        return project_model_links_update_immediately
