...
T = TypeVar("T", bound="TimeEntryModelLinksUpdateImmediately")
...
class TimeEntryModelLinksUpdateImmediately:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        time_entry_model_links_update_immediately = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        time_entry_model_links_update_immediately.additional_properties = d
        return time_entry_model_links_update_immediately
