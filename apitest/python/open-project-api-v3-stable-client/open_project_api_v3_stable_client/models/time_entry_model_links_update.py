...
T = TypeVar("T", bound="TimeEntryModelLinksUpdate")
...
class TimeEntryModelLinksUpdate:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        time_entry_model_links_update = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        time_entry_model_links_update.additional_properties = d
        return time_entry_model_links_update
