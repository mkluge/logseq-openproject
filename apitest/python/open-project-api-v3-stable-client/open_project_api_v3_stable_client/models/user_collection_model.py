...
if TYPE_CHECKING:
    ...
    from ..models.user_collection_model_embedded import UserCollectionModelEmbedded
    from ..models.user_collection_model_links import UserCollectionModelLinks


T = TypeVar("T", bound="UserCollectionModel")
...
class UserCollectionModel:
    """
    Example:
        {'_type': 'Collection', 'total': 2, 'count': 2, '_links': {'self': {'href': '/api/v3/users'}}, '_embedded':
            {'elements': [{'_hint': 'User resource shortened for brevity', '_type': 'User', 'id': 1337}, {'_hint': 'User
            resource shortened for brevity', '_type': 'User', 'id': 1338}]}}

    Attributes:
        field_links (UserCollectionModelLinks):
        field_embedded (UserCollectionModelEmbedded):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        field_links = UserCollectionModelLinks.from_dict(d.pop("_links"))

        field_embedded = UserCollectionModelEmbedded.from_dict(d.pop("_embedded"))
        ...
        user_collection_model.additional_properties = d
