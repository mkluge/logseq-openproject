...
T = TypeVar("T", bound="NotificationModelLinksProject")
...
class NotificationModelLinksProject:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        notification_model_links_project = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        notification_model_links_project.additional_properties = d
        return notification_model_links_project
