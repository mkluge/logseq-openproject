...
T = TypeVar("T", bound="QueryFilterInstanceSchemaModelLinksFilter")
...
class QueryFilterInstanceSchemaModelLinksFilter:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        query_filter_instance_schema_model_links_filter = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        query_filter_instance_schema_model_links_filter.additional_properties = d
        return query_filter_instance_schema_model_links_filter
