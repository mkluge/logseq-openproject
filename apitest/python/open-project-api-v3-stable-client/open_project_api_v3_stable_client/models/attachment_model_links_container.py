...
T = TypeVar("T", bound="AttachmentModelLinksContainer")
...
class AttachmentModelLinksContainer:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        attachment_model_links_container = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        attachment_model_links_container.additional_properties = d
        return attachment_model_links_container
