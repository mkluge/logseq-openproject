...
T = TypeVar("T", bound="WorkPackageModelLinksUnwatch")
...
class WorkPackageModelLinksUnwatch:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        work_package_model_links_unwatch = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        work_package_model_links_unwatch.additional_properties = d
        return work_package_model_links_unwatch
