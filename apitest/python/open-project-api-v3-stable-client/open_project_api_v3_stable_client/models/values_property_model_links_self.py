...
T = TypeVar("T", bound="ValuesPropertyModelLinksSelf")
...
class ValuesPropertyModelLinksSelf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        values_property_model_links_self = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        values_property_model_links_self.additional_properties = d
        return values_property_model_links_self
