...
T = TypeVar("T", bound="CategoryModelLinksSelf")
...
class CategoryModelLinksSelf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        category_model_links_self.additional_properties = d
        return category_model_links_self
