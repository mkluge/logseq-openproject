...
T = TypeVar("T", bound="RootModelLinksUserPreferences")
...
class RootModelLinksUserPreferences:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        root_model_links_user_preferences = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        root_model_links_user_preferences.additional_properties = d
        return root_model_links_user_preferences
