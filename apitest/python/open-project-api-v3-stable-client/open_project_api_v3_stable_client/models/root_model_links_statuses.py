...
T = TypeVar("T", bound="RootModelLinksStatuses")
...
class RootModelLinksStatuses:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        root_model_links_statuses.additional_properties = d
        return root_model_links_statuses
