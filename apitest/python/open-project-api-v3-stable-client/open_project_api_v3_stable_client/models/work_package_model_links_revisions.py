...
T = TypeVar("T", bound="WorkPackageModelLinksRevisions")
...
class WorkPackageModelLinksRevisions:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        work_package_model_links_revisions = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        work_package_model_links_revisions.additional_properties = d
        return work_package_model_links_revisions
