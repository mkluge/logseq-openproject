...
T = TypeVar("T", bound="WorkPackageModelLinksPreviewMarkup")
...
class WorkPackageModelLinksPreviewMarkup:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        work_package_model_links_preview_markup = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        work_package_model_links_preview_markup.additional_properties = d
        return work_package_model_links_preview_markup
