...
T = TypeVar("T", bound="HelptextModelLinksSelf")
...
class HelptextModelLinksSelf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        helptext_model_links_self.additional_properties = d
        return helptext_model_links_self
