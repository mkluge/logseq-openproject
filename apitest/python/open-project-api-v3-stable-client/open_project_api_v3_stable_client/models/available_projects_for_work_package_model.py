...
T = TypeVar("T", bound="AvailableProjectsForWorkPackageModel")


@attr.s(auto_attribs=True)
class AvailableProjectsForWorkPackageModel:
    """
    Example:
        {'_links': {'self': {'href': '/api/v3/work_packages/5/available_projects'}}, '_type': 'Collection', 'total': 2,
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        available_projects_for_work_package_model = cls()

        available_projects_for_work_package_model.additional_properties = d
        return available_projects_for_work_package_model
