...
T = TypeVar("T", bound="DocumentModelLinksSelf")
...
class DocumentModelLinksSelf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        document_model_links_self.additional_properties = d
        return document_model_links_self
