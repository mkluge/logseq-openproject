...
T = TypeVar("T", bound="RelationModelLinksSchema")
...
class RelationModelLinksSchema:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        relation_model_links_schema = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        relation_model_links_schema.additional_properties = d
        return relation_model_links_schema
