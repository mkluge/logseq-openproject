...
T = TypeVar("T", bound="CategoryModelLinksDefaultAssignee")
...
class CategoryModelLinksDefaultAssignee:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        category_model_links_default_assignee = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        category_model_links_default_assignee.additional_properties = d
        return category_model_links_default_assignee
