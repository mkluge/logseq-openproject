...
T = TypeVar("T", bound="TimeEntryActivityModelLinksSelf")
...
class TimeEntryActivityModelLinksSelf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        time_entry_activity_model_links_self = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        time_entry_activity_model_links_self.additional_properties = d
        return time_entry_activity_model_links_self
