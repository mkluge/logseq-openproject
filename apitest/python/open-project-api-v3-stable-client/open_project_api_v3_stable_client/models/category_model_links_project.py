...
T = TypeVar("T", bound="CategoryModelLinksProject")
...
class CategoryModelLinksProject:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        category_model_links_project = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        category_model_links_project.additional_properties = d
        return category_model_links_project
