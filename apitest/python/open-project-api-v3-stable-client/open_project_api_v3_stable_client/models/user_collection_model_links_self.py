...
T = TypeVar("T", bound="UserCollectionModelLinksSelf")


@attr.s(auto_attribs=True)
class UserCollectionModelLinksSelf:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        user_collection_model_links_self = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        user_collection_model_links_self.additional_properties = d
        return user_collection_model_links_self
