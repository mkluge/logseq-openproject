...
T = TypeVar("T", bound="UserPreferenceModelLinksUser")


@attr.s(auto_attribs=True)
class UserPreferenceModelLinksUser:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        user_preference_model_links_user = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        user_preference_model_links_user.additional_properties = d
        return user_preference_model_links_user
