...
T = TypeVar("T", bound="WorkPackageModelLinksSchema")
...
class WorkPackageModelLinksSchema:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        work_package_model_links_schema = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        work_package_model_links_schema.additional_properties = d
        return work_package_model_links_schema
