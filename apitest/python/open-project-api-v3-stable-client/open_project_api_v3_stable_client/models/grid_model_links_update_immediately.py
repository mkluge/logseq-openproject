...
T = TypeVar("T", bound="GridModelLinksUpdateImmediately")


@attr.s(auto_attribs=True)
class GridModelLinksUpdateImmediately:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        grid_model_links_update_immediately = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        grid_model_links_update_immediately.additional_properties = d
        return grid_model_links_update_immediately
