...
T = TypeVar("T", bound="NotificationModelLinksDetailsItem")


@attr.s(auto_attribs=True)
class NotificationModelLinksDetailsItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        notification_model_links_details_item = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        notification_model_links_details_item.additional_properties = d
        return notification_model_links_details_item
