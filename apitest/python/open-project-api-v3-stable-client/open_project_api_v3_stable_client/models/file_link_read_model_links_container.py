...
T = TypeVar("T", bound="FileLinkReadModelLinksContainer")
...
class FileLinkReadModelLinksContainer:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        file_link_read_model_links_container = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        file_link_read_model_links_container.additional_properties = d
        return file_link_read_model_links_container
