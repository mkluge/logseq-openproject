...
T = TypeVar("T", bound="FileLinkWriteModelLinksType1StorageUrl")


@attr.s(auto_attribs=True)
class FileLinkWriteModelLinksType1StorageUrl:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        file_link_write_model_links_type_1_storage_url = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        file_link_write_model_links_type_1_storage_url.additional_properties = d
        return file_link_write_model_links_type_1_storage_url
