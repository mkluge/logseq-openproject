...
T = TypeVar("T", bound="VersionModelDescription")


@attr.s(auto_attribs=True)
class VersionModelDescription:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        version_model_description = cls(
            format_=format_,
            raw=raw,
            html=html,
        )

        version_model_description.additional_properties = d
        return version_model_description
