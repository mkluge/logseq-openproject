...
T = TypeVar("T", bound="ProjectModelLinksMemberships")
...
class ProjectModelLinksMemberships:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_model_links_memberships = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        project_model_links_memberships.additional_properties = d
        return project_model_links_memberships
