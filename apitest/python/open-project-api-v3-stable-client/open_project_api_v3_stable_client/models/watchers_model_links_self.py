...
T = TypeVar("T", bound="WatchersModelLinksSelf")


@attr.s(auto_attribs=True)
class WatchersModelLinksSelf:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        watchers_model_links_self.additional_properties = d
        return watchers_model_links_self
