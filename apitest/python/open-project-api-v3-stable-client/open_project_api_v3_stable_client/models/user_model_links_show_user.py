...
T = TypeVar("T", bound="UserModelLinksShowUser")
...
class UserModelLinksShowUser:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        user_model_links_show_user = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        user_model_links_show_user.additional_properties = d
        return user_model_links_show_user
