...
T = TypeVar("T", bound="GridModelLinksPage")


@attr.s(auto_attribs=True)
class GridModelLinksPage:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        grid_model_links_page.additional_properties = d
        return grid_model_links_page
