...
T = TypeVar("T", bound="WorkPackageModelLinksWatch")
...
class WorkPackageModelLinksWatch:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        work_package_model_links_watch = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        work_package_model_links_watch.additional_properties = d
        return work_package_model_links_watch
