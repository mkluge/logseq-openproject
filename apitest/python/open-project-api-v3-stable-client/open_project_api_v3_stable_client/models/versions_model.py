...
T = TypeVar("T", bound="VersionsModel")
...
class VersionsModel:
    ...
    Example:
        {'_links': {'self': {'href': '/api/v3/versions'}}, 'total': 3, 'count': 3, '_type': 'Collection', '_embedded':
            {'elements': [{'_links': {'self': {'href': '/api/v3/versions/11'}, 'definingProject': {'href':
            '/api/v3/projects/12'}, 'availableInProjects': {'href': '/api/v3/versions/11/projects'}}, '_type': 'Version',
            ...
            '/api/v3/projects/13'}, 'availableInProjects': {'href': '/api/v3/versions/13/projects'}}, '_type': 'Version',
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        versions_model.additional_properties = d
