...
T = TypeVar("T", bound="WorkPackageModelLinksStatus")
...
class WorkPackageModelLinksStatus:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        work_package_model_links_status = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        work_package_model_links_status.additional_properties = d
        return work_package_model_links_status
