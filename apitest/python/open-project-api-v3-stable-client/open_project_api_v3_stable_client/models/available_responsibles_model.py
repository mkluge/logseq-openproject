...
T = TypeVar("T", bound="AvailableResponsiblesModel")


@attr.s(auto_attribs=True)
class AvailableResponsiblesModel:
    """
    Example:
        {'_links': {'self': {'href': '/api/v3/projects/42/available_responsibles'}}, 'total': 2, 'count': 2, '_type':
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        available_responsibles_model = cls()

        available_responsibles_model.additional_properties = d
        return available_responsibles_model
