...
T = TypeVar("T", bound="WorkPackageModelDescription")
...
class WorkPackageModelDescription:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        work_package_model_description = cls(
            format_=format_,
            raw=raw,
            html=html,
        )

        work_package_model_description.additional_properties = d
        return work_package_model_description
