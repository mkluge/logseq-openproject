...
T = TypeVar("T", bound="StorageFileLocationModelLinksSelf")


@attr.s(auto_attribs=True)
class StorageFileLocationModelLinksSelf:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        storage_file_location_model_links_self = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        storage_file_location_model_links_self.additional_properties = d
        return storage_file_location_model_links_self
