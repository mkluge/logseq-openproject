...
T = TypeVar("T", bound="ValuesPropertyModelLinksSchema")
...
class ValuesPropertyModelLinksSchema:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        values_property_model_links_schema = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        values_property_model_links_schema.additional_properties = d
        return values_property_model_links_schema
