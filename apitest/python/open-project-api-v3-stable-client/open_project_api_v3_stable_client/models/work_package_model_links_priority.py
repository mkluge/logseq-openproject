...
T = TypeVar("T", bound="WorkPackageModelLinksPriority")
...
class WorkPackageModelLinksPriority:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        work_package_model_links_priority = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        work_package_model_links_priority.additional_properties = d
        return work_package_model_links_priority
