...
T = TypeVar("T", bound="WorkPackageModelLinksAttachments")
...
class WorkPackageModelLinksAttachments:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        work_package_model_links_attachments = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        work_package_model_links_attachments.additional_properties = d
        return work_package_model_links_attachments
