...
T = TypeVar("T", bound="RelationModelLinksUpdate")
...
class RelationModelLinksUpdate:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        relation_model_links_update = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        relation_model_links_update.additional_properties = d
        return relation_model_links_update
