...
T = TypeVar("T", bound="WorkPackageModelLinksUpdateImmediately")
...
class WorkPackageModelLinksUpdateImmediately:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        work_package_model_links_update_immediately = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        work_package_model_links_update_immediately.additional_properties = d
        return work_package_model_links_update_immediately
