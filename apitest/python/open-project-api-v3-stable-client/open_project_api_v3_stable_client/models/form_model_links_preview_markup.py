...
T = TypeVar("T", bound="FormModelLinksPreviewMarkup")


@attr.s(auto_attribs=True)
class FormModelLinksPreviewMarkup:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        form_model_links_preview_markup = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        form_model_links_preview_markup.additional_properties = d
        return form_model_links_preview_markup
