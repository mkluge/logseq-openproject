...
T = TypeVar("T", bound="WorkPackageModelLinksBudget")
...
class WorkPackageModelLinksBudget:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        work_package_model_links_budget = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        work_package_model_links_budget.additional_properties = d
        return work_package_model_links_budget
