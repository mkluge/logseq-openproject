...
T = TypeVar("T", bound="DocumentModelLinksProject")
...
class DocumentModelLinksProject:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        document_model_links_project = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        document_model_links_project.additional_properties = d
        return document_model_links_project
