...
T = TypeVar("T", bound="WorkPackageModelLinksVersion")
...
class WorkPackageModelLinksVersion:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        work_package_model_links_version = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        work_package_model_links_version.additional_properties = d
        return work_package_model_links_version
