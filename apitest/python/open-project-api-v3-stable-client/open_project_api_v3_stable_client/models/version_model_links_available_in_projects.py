...
T = TypeVar("T", bound="VersionModelLinksAvailableInProjects")
...
class VersionModelLinksAvailableInProjects:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        version_model_links_available_in_projects = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        version_model_links_available_in_projects.additional_properties = d
        return version_model_links_available_in_projects
