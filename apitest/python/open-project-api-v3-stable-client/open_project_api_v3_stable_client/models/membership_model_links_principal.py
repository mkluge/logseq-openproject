...
T = TypeVar("T", bound="MembershipModelLinksPrincipal")


@attr.s(auto_attribs=True)
class MembershipModelLinksPrincipal:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        membership_model_links_principal = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        membership_model_links_principal.additional_properties = d
        return membership_model_links_principal
