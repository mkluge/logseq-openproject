...
T = TypeVar("T", bound="WorkPackageModelLinksUpdate")
...
class WorkPackageModelLinksUpdate:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        work_package_model_links_update = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        work_package_model_links_update.additional_properties = d
        return work_package_model_links_update
