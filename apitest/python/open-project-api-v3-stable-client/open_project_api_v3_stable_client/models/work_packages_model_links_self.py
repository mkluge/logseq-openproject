...
T = TypeVar("T", bound="WorkPackagesModelLinksSelf")


@attr.s(auto_attribs=True)
class WorkPackagesModelLinksSelf:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        work_packages_model_links_self = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        work_packages_model_links_self.additional_properties = d
        return work_packages_model_links_self
