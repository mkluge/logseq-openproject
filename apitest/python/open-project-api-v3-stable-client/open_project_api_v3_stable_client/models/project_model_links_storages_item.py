...
T = TypeVar("T", bound="ProjectModelLinksStoragesItem")


@attr.s(auto_attribs=True)
class ProjectModelLinksStoragesItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_model_links_storages_item = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        project_model_links_storages_item.additional_properties = d
        return project_model_links_storages_item
