...
T = TypeVar("T", bound="RevisionModelLinksAuthor")
...
class RevisionModelLinksAuthor:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        revision_model_links_author = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        revision_model_links_author.additional_properties = d
        return revision_model_links_author
