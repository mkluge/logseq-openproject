...
T = TypeVar("T", bound="RelationModelLinksUpdateImmediately")
...
class RelationModelLinksUpdateImmediately:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        relation_model_links_update_immediately = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        relation_model_links_update_immediately.additional_properties = d
        return relation_model_links_update_immediately
