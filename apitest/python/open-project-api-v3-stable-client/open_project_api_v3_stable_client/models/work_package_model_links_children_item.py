...
T = TypeVar("T", bound="WorkPackageModelLinksChildrenItem")


@attr.s(auto_attribs=True)
class WorkPackageModelLinksChildrenItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        work_package_model_links_children_item = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        work_package_model_links_children_item.additional_properties = d
        return work_package_model_links_children_item
