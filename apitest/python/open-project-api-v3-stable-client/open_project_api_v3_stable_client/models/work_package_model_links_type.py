...
T = TypeVar("T", bound="WorkPackageModelLinksType")
...
class WorkPackageModelLinksType:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        work_package_model_links_type = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        work_package_model_links_type.additional_properties = d
        return work_package_model_links_type
