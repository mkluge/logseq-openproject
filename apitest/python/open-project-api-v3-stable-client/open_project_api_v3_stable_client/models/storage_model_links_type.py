...
T = TypeVar("T", bound="StorageModelLinksType")


@attr.s(auto_attribs=True)
class StorageModelLinksType:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        storage_model_links_type.additional_properties = d
        return storage_model_links_type
