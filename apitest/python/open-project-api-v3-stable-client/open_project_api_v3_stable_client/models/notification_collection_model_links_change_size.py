...
T = TypeVar("T", bound="NotificationCollectionModelLinksChangeSize")


@attr.s(auto_attribs=True)
class NotificationCollectionModelLinksChangeSize:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        notification_collection_model_links_change_size = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        notification_collection_model_links_change_size.additional_properties = d
        return notification_collection_model_links_change_size
