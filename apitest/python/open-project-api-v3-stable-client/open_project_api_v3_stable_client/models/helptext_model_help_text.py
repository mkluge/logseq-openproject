...
T = TypeVar("T", bound="HelptextModelHelpText")


@attr.s(auto_attribs=True)
class HelptextModelHelpText:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        helptext_model_help_text = cls(
            format_=format_,
            raw=raw,
            html=html,
        )

        helptext_model_help_text.additional_properties = d
        return helptext_model_help_text
