...
T = TypeVar("T", bound="StarQueryModel")


@attr.s(auto_attribs=True)
class StarQueryModel:
    """
    Example:
        {'_type': 'Query', 'id': 9, 'name': 'fdsfdsfdsf', 'createdAt': '2015-03-20T12:56:56Z', 'updatedAt':
            ...
            '_embedded': {'results': {'_type': 'WorkPackageCollection', 'total': 234, 'count': 30, 'pageSize': 2, 'offset':
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        star_query_model = cls()

        star_query_model.additional_properties = d
        return star_query_model
