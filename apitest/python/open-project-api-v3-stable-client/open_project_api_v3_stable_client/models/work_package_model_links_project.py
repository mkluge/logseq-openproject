...
T = TypeVar("T", bound="WorkPackageModelLinksProject")
...
class WorkPackageModelLinksProject:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        work_package_model_links_project = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        work_package_model_links_project.additional_properties = d
        return work_package_model_links_project
