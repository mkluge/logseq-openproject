...
T = TypeVar("T", bound="NonWorkingDayModelLinksSelf")
...
class NonWorkingDayModelLinksSelf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        non_working_day_model_links_self = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        non_working_day_model_links_self.additional_properties = d
        return non_working_day_model_links_self
