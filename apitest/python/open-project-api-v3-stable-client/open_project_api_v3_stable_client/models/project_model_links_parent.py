...
T = TypeVar("T", bound="ProjectModelLinksParent")
...
class ProjectModelLinksParent:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_model_links_parent = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        project_model_links_parent.additional_properties = d
        return project_model_links_parent
