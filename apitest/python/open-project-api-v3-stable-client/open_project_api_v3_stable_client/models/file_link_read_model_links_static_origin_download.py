...
T = TypeVar("T", bound="FileLinkReadModelLinksStaticOriginDownload")
...
class FileLinkReadModelLinksStaticOriginDownload:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        file_link_read_model_links_static_origin_download = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        file_link_read_model_links_static_origin_download.additional_properties = d
        return file_link_read_model_links_static_origin_download
