...
T = TypeVar("T", bound="TimeEntryModelLinksWorkPackage")
...
class TimeEntryModelLinksWorkPackage:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        time_entry_model_links_work_package = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        time_entry_model_links_work_package.additional_properties = d
        return time_entry_model_links_work_package
