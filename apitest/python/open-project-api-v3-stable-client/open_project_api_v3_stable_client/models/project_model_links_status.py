...
T = TypeVar("T", bound="ProjectModelLinksStatus")
...
class ProjectModelLinksStatus:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_model_links_status = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        project_model_links_status.additional_properties = d
        return project_model_links_status
