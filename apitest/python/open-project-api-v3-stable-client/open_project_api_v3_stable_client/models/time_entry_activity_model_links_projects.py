...
T = TypeVar("T", bound="TimeEntryActivityModelLinksProjects")


@attr.s(auto_attribs=True)
class TimeEntryActivityModelLinksProjects:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        time_entry_activity_model_links_projects = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        time_entry_activity_model_links_projects.additional_properties = d
        return time_entry_activity_model_links_projects
