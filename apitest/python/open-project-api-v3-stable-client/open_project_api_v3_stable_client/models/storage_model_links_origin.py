...
T = TypeVar("T", bound="StorageModelLinksOrigin")


@attr.s(auto_attribs=True)
class StorageModelLinksOrigin:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        storage_model_links_origin = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        storage_model_links_origin.additional_properties = d
        return storage_model_links_origin
