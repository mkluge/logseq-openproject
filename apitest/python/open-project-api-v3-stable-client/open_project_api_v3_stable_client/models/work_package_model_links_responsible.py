...
T = TypeVar("T", bound="WorkPackageModelLinksResponsible")
...
class WorkPackageModelLinksResponsible:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        work_package_model_links_responsible = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        work_package_model_links_responsible.additional_properties = d
        return work_package_model_links_responsible
