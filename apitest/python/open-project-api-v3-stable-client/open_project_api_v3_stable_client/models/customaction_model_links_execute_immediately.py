...
T = TypeVar("T", bound="CustomactionModelLinksExecuteImmediately")
...
class CustomactionModelLinksExecuteImmediately:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        customaction_model_links_execute_immediately = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        customaction_model_links_execute_immediately.additional_properties = d
        return customaction_model_links_execute_immediately
