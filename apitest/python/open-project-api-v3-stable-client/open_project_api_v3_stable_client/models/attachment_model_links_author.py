...
T = TypeVar("T", bound="AttachmentModelLinksAuthor")
...
class AttachmentModelLinksAuthor:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        attachment_model_links_author = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        attachment_model_links_author.additional_properties = d
        return attachment_model_links_author
