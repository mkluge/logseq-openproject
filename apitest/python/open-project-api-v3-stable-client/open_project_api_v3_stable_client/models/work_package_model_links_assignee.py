...
T = TypeVar("T", bound="WorkPackageModelLinksAssignee")
...
class WorkPackageModelLinksAssignee:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        work_package_model_links_assignee = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        work_package_model_links_assignee.additional_properties = d
        return work_package_model_links_assignee
