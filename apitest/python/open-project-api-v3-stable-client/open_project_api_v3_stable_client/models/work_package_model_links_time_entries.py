...
T = TypeVar("T", bound="WorkPackageModelLinksTimeEntries")
...
class WorkPackageModelLinksTimeEntries:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        work_package_model_links_time_entries = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        work_package_model_links_time_entries.additional_properties = d
        return work_package_model_links_time_entries
