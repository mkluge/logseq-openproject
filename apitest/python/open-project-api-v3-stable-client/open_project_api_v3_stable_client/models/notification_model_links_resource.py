...
T = TypeVar("T", bound="NotificationModelLinksResource")
...
class NotificationModelLinksResource:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        notification_model_links_resource = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        notification_model_links_resource.additional_properties = d
        return notification_model_links_resource
