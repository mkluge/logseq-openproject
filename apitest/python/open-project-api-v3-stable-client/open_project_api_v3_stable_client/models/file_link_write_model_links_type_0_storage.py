...
T = TypeVar("T", bound="FileLinkWriteModelLinksType0Storage")


@attr.s(auto_attribs=True)
class FileLinkWriteModelLinksType0Storage:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        file_link_write_model_links_type_0_storage = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        file_link_write_model_links_type_0_storage.additional_properties = d
        return file_link_write_model_links_type_0_storage
