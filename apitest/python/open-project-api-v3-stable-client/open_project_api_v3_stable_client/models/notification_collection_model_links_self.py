...
T = TypeVar("T", bound="NotificationCollectionModelLinksSelf")


@attr.s(auto_attribs=True)
class NotificationCollectionModelLinksSelf:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        notification_collection_model_links_self = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        notification_collection_model_links_self.additional_properties = d
        return notification_collection_model_links_self
