...
T = TypeVar("T", bound="AttachmentModelLinksDownloadLocation")
...
class AttachmentModelLinksDownloadLocation:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        attachment_model_links_download_location = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        attachment_model_links_download_location.additional_properties = d
        return attachment_model_links_download_location
