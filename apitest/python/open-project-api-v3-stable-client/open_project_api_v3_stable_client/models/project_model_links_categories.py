...
T = TypeVar("T", bound="ProjectModelLinksCategories")
...
class ProjectModelLinksCategories:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_model_links_categories = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        project_model_links_categories.additional_properties = d
        return project_model_links_categories
