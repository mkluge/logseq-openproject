...
T = TypeVar("T", bound="FileLinkCollectionReadModelLinksSelf")


@attr.s(auto_attribs=True)
class FileLinkCollectionReadModelLinksSelf:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        file_link_collection_read_model_links_self = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        file_link_collection_read_model_links_self.additional_properties = d
        return file_link_collection_read_model_links_self
