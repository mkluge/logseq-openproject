...
T = TypeVar("T", bound="CustomOptionModelLinksSelf")
...
class CustomOptionModelLinksSelf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        custom_option_model_links_self = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        custom_option_model_links_self.additional_properties = d
        return custom_option_model_links_self
