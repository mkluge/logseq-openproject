...
T = TypeVar("T", bound="RelationModelLinksFrom")
...
class RelationModelLinksFrom:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        relation_model_links_from.additional_properties = d
        return relation_model_links_from
