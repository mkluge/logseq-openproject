...
T = TypeVar("T", bound="TimeEntryModelLinksUser")
...
class TimeEntryModelLinksUser:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        time_entry_model_links_user = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        time_entry_model_links_user.additional_properties = d
        return time_entry_model_links_user
