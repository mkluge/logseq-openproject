...
T = TypeVar("T", bound="UserModelLinksMemberships")
...
class UserModelLinksMemberships:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        user_model_links_memberships = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        user_model_links_memberships.additional_properties = d
        return user_model_links_memberships
