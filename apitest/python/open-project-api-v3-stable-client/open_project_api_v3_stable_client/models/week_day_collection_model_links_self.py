...
T = TypeVar("T", bound="WeekDayCollectionModelLinksSelf")


@attr.s(auto_attribs=True)
class WeekDayCollectionModelLinksSelf:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        week_day_collection_model_links_self = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        week_day_collection_model_links_self.additional_properties = d
        return week_day_collection_model_links_self
