...
T = TypeVar("T", bound="FileLinkReadModelLinksPermission")
...
class FileLinkReadModelLinksPermission:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        file_link_read_model_links_permission = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        file_link_read_model_links_permission.additional_properties = d
        return file_link_read_model_links_permission
