...
T = TypeVar("T", bound="NotificationCollectionModelLinksJumpTo")


@attr.s(auto_attribs=True)
class NotificationCollectionModelLinksJumpTo:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        notification_collection_model_links_jump_to = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        notification_collection_model_links_jump_to.additional_properties = d
        return notification_collection_model_links_jump_to
