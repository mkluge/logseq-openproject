...
T = TypeVar("T", bound="MembershipModelLinksRoles")


@attr.s(auto_attribs=True)
class MembershipModelLinksRoles:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        membership_model_links_roles = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        membership_model_links_roles.additional_properties = d
        return membership_model_links_roles
