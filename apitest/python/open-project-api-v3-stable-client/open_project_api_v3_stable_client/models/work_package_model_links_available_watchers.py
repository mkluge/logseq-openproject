...
T = TypeVar("T", bound="WorkPackageModelLinksAvailableWatchers")
...
class WorkPackageModelLinksAvailableWatchers:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        work_package_model_links_available_watchers = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        work_package_model_links_available_watchers.additional_properties = d
        return work_package_model_links_available_watchers
