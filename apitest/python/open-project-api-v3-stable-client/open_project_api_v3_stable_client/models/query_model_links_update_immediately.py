...
T = TypeVar("T", bound="QueryModelLinksUpdateImmediately")
...
class QueryModelLinksUpdateImmediately:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        query_model_links_update_immediately = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        query_model_links_update_immediately.additional_properties = d
        return query_model_links_update_immediately
