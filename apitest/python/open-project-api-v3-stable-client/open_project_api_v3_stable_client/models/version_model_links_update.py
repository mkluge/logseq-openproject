...
T = TypeVar("T", bound="VersionModelLinksUpdate")
...
class VersionModelLinksUpdate:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        version_model_links_update = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        version_model_links_update.additional_properties = d
        return version_model_links_update
