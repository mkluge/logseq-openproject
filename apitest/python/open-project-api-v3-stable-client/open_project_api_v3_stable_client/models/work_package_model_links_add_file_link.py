...
T = TypeVar("T", bound="WorkPackageModelLinksAddFileLink")
...
class WorkPackageModelLinksAddFileLink:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        work_package_model_links_add_file_link = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        work_package_model_links_add_file_link.additional_properties = d
        return work_package_model_links_add_file_link
