...
T = TypeVar("T", bound="PriorityModelLinksSelf")
...
class PriorityModelLinksSelf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        priority_model_links_self.additional_properties = d
        return priority_model_links_self
