...
T = TypeVar("T", bound="NotificationModelLinksActivity")
...
class NotificationModelLinksActivity:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        notification_model_links_activity = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        notification_model_links_activity.additional_properties = d
        return notification_model_links_activity
