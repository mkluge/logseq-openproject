...
T = TypeVar("T", bound="ProjectModelLinksVersions")
...
class ProjectModelLinksVersions:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_model_links_versions = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        project_model_links_versions.additional_properties = d
        return project_model_links_versions
