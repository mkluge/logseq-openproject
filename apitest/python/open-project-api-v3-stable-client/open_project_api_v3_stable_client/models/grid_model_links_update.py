...
T = TypeVar("T", bound="GridModelLinksUpdate")


@attr.s(auto_attribs=True)
class GridModelLinksUpdate:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        grid_model_links_update.additional_properties = d
        return grid_model_links_update
