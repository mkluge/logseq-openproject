...
T = TypeVar("T", bound="UserPreferenceModelLinksSelf")


@attr.s(auto_attribs=True)
class UserPreferenceModelLinksSelf:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        user_preference_model_links_self = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        user_preference_model_links_self.additional_properties = d
        return user_preference_model_links_self
