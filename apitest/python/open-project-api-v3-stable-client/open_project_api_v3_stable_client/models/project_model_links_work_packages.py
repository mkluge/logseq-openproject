...
T = TypeVar("T", bound="ProjectModelLinksWorkPackages")
...
class ProjectModelLinksWorkPackages:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_model_links_work_packages = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        project_model_links_work_packages.additional_properties = d
        return project_model_links_work_packages
