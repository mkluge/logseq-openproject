...
T = TypeVar("T", bound="FormModelLinksValidate")


@attr.s(auto_attribs=True)
class FormModelLinksValidate:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        form_model_links_validate.additional_properties = d
        return form_model_links_validate
