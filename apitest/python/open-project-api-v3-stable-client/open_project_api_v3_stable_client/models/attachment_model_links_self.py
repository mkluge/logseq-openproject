...
T = TypeVar("T", bound="AttachmentModelLinksSelf")
...
class AttachmentModelLinksSelf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        attachment_model_links_self = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        attachment_model_links_self.additional_properties = d
        return attachment_model_links_self
