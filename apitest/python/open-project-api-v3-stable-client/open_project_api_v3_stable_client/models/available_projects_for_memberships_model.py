...
T = TypeVar("T", bound="AvailableProjectsForMembershipsModel")


@attr.s(auto_attribs=True)
class AvailableProjectsForMembershipsModel:
    """
    Example:
        {'_links': {'self': {'href': '/api/v3/memberships/available_projects'}}, '_type': 'Collection', 'total': 2,
            ...
            {'href': '/api/v3/projects/6/categories'}, 'memberships': {'href': '/api/v3/projects/6/memberships'}}, 'id': 6,
            ...
            '/api/v3/projects/14/categories'}, 'memberships': {'href': '/api/v3/projects/14/memberships'}}, 'id': 14,
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        available_projects_for_memberships_model = cls()

        available_projects_for_memberships_model.additional_properties = d
        return available_projects_for_memberships_model
