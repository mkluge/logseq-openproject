...
T = TypeVar("T", bound="RelationModelLinksDelete")
...
class RelationModelLinksDelete:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        relation_model_links_delete = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        relation_model_links_delete.additional_properties = d
        return relation_model_links_delete
