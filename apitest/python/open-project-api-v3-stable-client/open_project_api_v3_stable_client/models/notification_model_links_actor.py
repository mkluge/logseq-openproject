...
T = TypeVar("T", bound="NotificationModelLinksActor")
...
class NotificationModelLinksActor:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        notification_model_links_actor = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        notification_model_links_actor.additional_properties = d
        return notification_model_links_actor
