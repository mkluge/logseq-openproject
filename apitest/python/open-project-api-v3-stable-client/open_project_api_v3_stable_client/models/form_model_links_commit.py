...
T = TypeVar("T", bound="FormModelLinksCommit")


@attr.s(auto_attribs=True)
class FormModelLinksCommit:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        form_model_links_commit.additional_properties = d
        return form_model_links_commit
