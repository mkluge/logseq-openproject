...
T = TypeVar("T", bound="DayCollectionModelLinksSelf")


@attr.s(auto_attribs=True)
class DayCollectionModelLinksSelf:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        day_collection_model_links_self = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        day_collection_model_links_self.additional_properties = d
        return day_collection_model_links_self
