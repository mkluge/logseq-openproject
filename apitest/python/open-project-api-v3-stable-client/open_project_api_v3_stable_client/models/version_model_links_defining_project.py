...
T = TypeVar("T", bound="VersionModelLinksDefiningProject")
...
class VersionModelLinksDefiningProject:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        version_model_links_defining_project = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        version_model_links_defining_project.additional_properties = d
        return version_model_links_defining_project
