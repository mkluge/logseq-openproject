...
if TYPE_CHECKING:
    ...
    from ..models.week_day_collection_model_embedded import WeekDayCollectionModelEmbedded
    from ..models.week_day_collection_model_links import WeekDayCollectionModelLinks


T = TypeVar("T", bound="WeekDayCollectionModel")
...
class WeekDayCollectionModel:
    """
    Example:
        {'_type': 'Collection', 'total': 7, 'count': 7, '_links': {'self': {'href': '/api/v3/days/week'}}, '_embedded':
            {'elements': [{'_type': 'WeekDay', 'day': 1, 'name': 'Monday', 'working': True, '_links': {'self': {'href':
            '/api/v3/days/week/1', 'title': 'Monday'}}}, {'_type': 'WeekDay', 'day': 2, 'name': 'Tuesday', 'working': True,
            '_links': {'self': {'href': '/api/v3/days/week/2', 'title': 'Tuesday'}}}, {'_type': 'WeekDay', 'day': 3, 'name':
            'Wednesday', 'working': True, '_links': {'self': {'href': '/api/v3/days/week/3', 'title': 'Wednesday'}}},
            {'_type': 'WeekDay', 'day': 4, 'name': 'Thursday', 'working': True, '_links': {'self': {'href':
            '/api/v3/days/week/4', 'title': 'Thursday'}}}, {'_type': 'WeekDay', 'day': 5, 'name': 'Friday', 'working': True,
            '_links': {'self': {'href': '/api/v3/days/week/5', 'title': 'Friday'}}}, {'_type': 'WeekDay', 'day': 6, 'name':
            'Saturday', 'working': False, '_links': {'self': {'href': '/api/v3/days/week/6', 'title': 'Saturday'}}},
            {'_type': 'WeekDay', 'day': 7, 'name': 'Sunday', 'working': False, '_links': {'self': {'href':
            '/api/v3/days/week/7', 'title': 'Sunday'}}}]}}

    Attributes:
        field_links (WeekDayCollectionModelLinks):
        field_embedded (WeekDayCollectionModelEmbedded):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        field_links = WeekDayCollectionModelLinks.from_dict(d.pop("_links"))

        field_embedded = WeekDayCollectionModelEmbedded.from_dict(d.pop("_embedded"))
        ...
        week_day_collection_model.additional_properties = d
        return week_day_collection_model
