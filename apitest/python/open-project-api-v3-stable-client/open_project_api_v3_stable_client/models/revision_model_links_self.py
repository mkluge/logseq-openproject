...
T = TypeVar("T", bound="RevisionModelLinksSelf")
...
class RevisionModelLinksSelf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        revision_model_links_self.additional_properties = d
        return revision_model_links_self
