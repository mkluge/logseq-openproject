...
T = TypeVar("T", bound="ProjectModelLinksUpdate")
...
class ProjectModelLinksUpdate:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_model_links_update = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        project_model_links_update.additional_properties = d
        return project_model_links_update
