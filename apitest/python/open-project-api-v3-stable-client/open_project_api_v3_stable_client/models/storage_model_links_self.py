...
T = TypeVar("T", bound="StorageModelLinksSelf")


@attr.s(auto_attribs=True)
class StorageModelLinksSelf:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        storage_model_links_self.additional_properties = d
        return storage_model_links_self
