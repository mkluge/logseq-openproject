...
T = TypeVar("T", bound="AttachmentModelLinksDelete")
...
class AttachmentModelLinksDelete:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        attachment_model_links_delete = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        attachment_model_links_delete.additional_properties = d
        return attachment_model_links_delete
