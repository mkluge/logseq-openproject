...
T = TypeVar("T", bound="VersionModelLinksUpdateImmediately")
...
class VersionModelLinksUpdateImmediately:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        version_model_links_update_immediately = cls(
            href=href,
            title=title,
            templated=templated,
            method=method,
        ...
        version_model_links_update_immediately.additional_properties = d
        return version_model_links_update_immediately
